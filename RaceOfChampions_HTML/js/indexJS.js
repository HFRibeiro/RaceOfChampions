  ...
  $("#maxima").click(function(){
   ...
   $("#delete").click(function(){
    ...
    $("#startCompetition").click(function(){
	  window.location.href = "race16.php";
   });
   ...
   $("#saveAll").click(function(){
	  ...
	  document.getElementById("oitavos").value = document.getElementById("InputOitavos").value;
	  document.getElementById("quartos").value = document.getElementById("InputQuartos").value;
	  document.getElementById("meias").value = document.getElementById("InputMeias").value;
	  document.getElementById("terceiro").value = document.getElementById("InputTerceiro").value;
	  document.getElementById("final").value = document.getElementById("InputFinal").value;
