<?php
	...
	$sql_select="INSERT INTO `".$banco_dados."`.`".$nome_tabela."` (`id`, `nome`, `valor`) VALUES (NULL, 'oitavos', '".$oitavos."');";
	try
	{
		$stmt = $pdo->prepare($sql_select);
		$data = $stmt->execute();
	...
	$sql_select="INSERT INTO `".$banco_dados."`.`".$nome_tabela."` (`id`, `nome`, `valor`) VALUES (NULL, 'quartos', '".$quartos."');";
	try
	{
		$stmt = $pdo->prepare($sql_select);
		$data = $stmt->execute();
	...
	$sql_select="INSERT INTO `".$banco_dados."`.`".$nome_tabela."` (`id`, `nome`, `valor`) VALUES (NULL, 'meias', '".$meias."');";
	try
	{
		$stmt = $pdo->prepare($sql_select);
		$data = $stmt->execute();
	...
	$sql_select="INSERT INTO `".$banco_dados."`.`".$nome_tabela."` (`id`, `nome`, `valor`) VALUES (NULL, 'final', '".$final."');";
	try
	{
		$stmt = $pdo->prepare($sql_select);
		$data = $stmt->execute();
	...
	$sql_select="INSERT INTO `".$banco_dados."`.`".$nome_tabela."` (`id`, `nome`, `valor`) VALUES (NULL, 'terceiro', '".$terceiro."');";
	try
	{
		$stmt = $pdo->prepare($sql_select);
		$data = $stmt->execute();
